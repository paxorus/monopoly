...
const PlaceConfigs = [
	...
	{name: "Mediterranean Avenue", price: 60, rents: [2, 10, 30, 90, 160, 250], housePrice: 50, color: Colors.BROWN},
	...
	{name: "Oriental Avenue", price: 100, rents: [6, 30, 90, 270, 400, 550], housePrice: 50, color: Colors.SKY_BLUE},
	{name: "Chance", price: 0, color: "#A6A", imageName: "/images/chance-pink.svg"},
	{name: "Vermont Avenue", price: 100, rents: [6, 30, 90, 270, 400, 550], housePrice: 50, color: Colors.SKY_BLUE},
	{name: "Connecticut Avenue", price: 120, rents: [8, 40, 100, 300, 450, 600], housePrice: 50, color: Colors.SKY_BLUE},
	{name: "Just Visiting", price: 0, color: "rgb(213, 232, 212)", cardColor: Colors.GRAY},
	{name: "St. Charles Place", price: 140, rents: [10, 50, 150, 450, 625, 750], housePrice: 100, color: Colors.PINK},
	...
	{name: "States Avenue", price: 140, rents: [10, 50, 150, 450, 625, 750], housePrice: 100, color: Colors.PINK},
	{name: "Virginia Avenue", price: 160, rents: [12, 60, 180, 500, 700, 900], housePrice: 100, color: Colors.PINK},
	{name: "Pennsylvania Railroad", price: 200, rents: [25, 50, 100, 200], color: Colors.RAILROAD, imageName: "/images/railroad.svg"},
	{name: "St. James Place", price: 180, rents: [14, 70, 200, 550, 750, 950], housePrice: 100, color: Colors.ORANGE},
	{name: "Community Chest", price: 0, color: "#48C", imageName: "/images/community-chest.svg"},
	{name: "Tennessee Avenue", price: 180, rents: [14, 70, 200, 550, 750, 950], housePrice: 100, color: Colors.ORANGE},
	{name: "New York Avenue", price: 200, rents: [16, 80, 220, 600, 800, 1000], housePrice: 100, color: Colors.ORANGE},
	{name: "Free Parking", price: 0, color: "rgb(213, 232, 212)", cardColor: Colors.GRAY, imageName: "/images/free-parking.svg"},
	{name: "Kentucky Avenue", price: 220, rents: [18, 90, 250, 700, 875, 1050], housePrice: 150, color: Colors.RED},
	{name: "Chance", price: 0, color: "#A6A", imageName: "/images/chance-blue.svg"},
	{name: "Indiana Avenue", price: 220, rents: [18, 90, 250, 700, 875, 1050], housePrice: 150, color: Colors.RED},
	{name: "Illinois Avenue", price: 240, rents: [20, 100, 300, 750, 925, 1100], housePrice: 150, color: Colors.RED},
	{name: "B. & O. Railroad", price: 200, rents: [25, 50, 100, 200], color: Colors.RAILROAD, imageName: "/images/railroad.svg"},
	{name: "Atlantic Avenue", price: 260, rents: [22, 110, 330, 800, 975, 1150], housePrice: 150, color: Colors.YELLOW},
	{name: "Ventnor Avenue", price: 260, rents: [22, 110, 330, 800, 975, 1150], housePrice: 150, color: Colors.YELLOW},
	{name: "Water Works", price: 150, rents: [0, 0, 0, 0, 0, 0], housePrice: 0, color: Colors.UTILITY, imageName: "/images/water-works.svg"},
	{name: "Marvin Gardens", price: 280, rents: [24, 120, 360, 850, 1025, 1200], housePrice: 150, color: Colors.YELLOW},
	{name: "Go To Jail", price: 0, color: "rgb(213, 232, 212)", cardColor: Colors.GRAY, imageName: "/images/go-to-jail.svg"},
	{name: "Pacific Avenue", price: 300, rents: [26, 130, 390, 900, 1100, 1275], housePrice: 200, color: Colors.GREEN},
	{name: "North Carolina Avenue", price: 300, rents: [26, 130, 390, 900, 1100, 1275], housePrice: 200, color: Colors.GREEN},
	{name: "Community Chest", price: 0, color: "#48C", imageName: "/images/community-chest.svg"},
	{name: "Pennsylvania Avenue", price: 320, rents: [28, 150, 450, 1000, 1200, 1400], housePrice: 200, color: Colors.GREEN},
